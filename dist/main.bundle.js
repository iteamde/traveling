    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_7__ngrx_store__["j" /* StoreModule */].forRoot(__WEBPACK_IMPORTED_MODULE_8__core_reducers__["t" /* reducers */]),
...
var appRoutes = [
    {
        ...
        children: __WEBPACK_IMPORTED_MODULE_2__auth_auth_routing__["a" /* AuthRoutes */].concat(__WEBPACK_IMPORTED_MODULE_3__trip_planner_trip_planner_routing__["a" /* TripPlannerRoutes */], __WEBPACK_IMPORTED_MODULE_4__home_home_routing__["a" /* HomeRoutes */], __WEBPACK_IMPORTED_MODULE_8__country_country_routing__["a" /* CountryRoutes */]),
    },
    {
        path: 'privacy-policy',
...
var LOGIN_SUCCESS = '[Auth] login su  ccess';
...
var AuthComponent = /** @class */ (function () {
    function AuthComponent(router, store) {
        ...
        store.select(__WEBPACK_IMPORTED_MODULE_3__core_reducers__["m" /* getLoginStatus */]).subscribe(function (res) { return _this.loginStatus = res; });
    }
...
var ForgotPasswordComponent = /** @class */ (function () {
    function ForgotPasswordComponent(store, fb, validation) {
        ...
        this.resetPasswordStatus$ = store.select(__WEBPACK_IMPORTED_MODULE_1__core_reducers__["q" /* getResetPasswordStatus */]);
        this.errorFromServer$ = store.select(__WEBPACK_IMPORTED_MODULE_1__core_reducers__["j" /* getErrorFromServer */]);
    }
...
var RegistrationGuard = /** @class */ (function () {
    ...
    function RegistrationGuard(store, router) {
        ...
        this.registrationStep$ = store.select(__WEBPACK_IMPORTED_MODULE_6__core_reducers__["p" /* getRegistationStep */]);
    }
    /**
...
var SearchBoxComponent = /** @class */ (function () {
    function SearchBoxComponent(apiService, store, fb) {
        ...
        this.limit = 20;
        this.offset = 0;
        this.user$ = store.select(__WEBPACK_IMPORTED_MODULE_3__core_reducers__["l" /* getLoggedUser */]);
    }
...
var LoginModalComponent = /** @class */ (function () {
    function LoginModalComponent(route, store, facebookService, api, fb, validation) {
        ...
        this.authError$ = store.select(__WEBPACK_IMPORTED_MODULE_5__core_reducers__["j" /* getErrorFromServer */]);
        this.loginStatus$ = store.select(__WEBPACK_IMPORTED_MODULE_5__core_reducers__["m" /* getLoginStatus */]);
...
var RegisterModalStep2Component = /** @class */ (function () {
    function RegisterModalStep2Component(store, fb, validation) {
        ...
        this.user$ = store.select(__WEBPACK_IMPORTED_MODULE_2__core_reducers__["l" /* getLoggedUser */]);
        this.authError$ = store.select(__WEBPACK_IMPORTED_MODULE_2__core_reducers__["j" /* getErrorFromServer */]);
    }
...
var RegisterModalComponent = /** @class */ (function () {
    function RegisterModalComponent(store, fb, validation, modalManager) {
        ...
        this.authError$ = store.select(__WEBPACK_IMPORTED_MODULE_4__core_reducers__["j" /* getErrorFromServer */]);
    }
...
var GalleryModalComponent = /** @class */ (function () {
    ...
    GalleryModalComponent.prototype.closeModal = function () {
        this.data.close();
        this.subscriptions.push(this.store.select(__WEBPACK_IMPORTED_MODULE_3__core_reducers__["n" /* getOpenedModalRef */]).take(1).subscribe(function (res) { return res && res.close(); }));
    };
...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(store) {
        this.store = store;
        this.registrationStep$ = store.select(__WEBPACK_IMPORTED_MODULE_2__reducers_index__["p" /* getRegistationStep */]);
    }
...
var CoreEffects = /** @class */ (function () {
    function CoreEffects(actions$, store) {
        ...
        this.navigateBack$ = this.actions$.ofType(__WEBPACK_IMPORTED_MODULE_2__actions_core_actions__["a" /* CLOSE_OPENED_MODAL */])
            .do(function () { return _this.store.select(__WEBPACK_IMPORTED_MODULE_4__reducers__["n" /* getOpenedModalRef */]).take(1).subscribe(function (res) { return res && res.close(); }); });
    }
    __decorate([
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "t", function() { return reducers; });
/* unused harmony export getCoreState */
/* unused harmony export getAuthState */
/* unused harmony export getErrorState */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "s", function() { return getTripPlannerState; });
/* unused harmony export getCountryState */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return getOpenedModalRef; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return getErrorFromServer; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return getLoggedUser; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return getRegistationStep; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return getResetPasswordStatus; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return getLoginStatus; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return getFollowStatus; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return getTripMedia; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "o", function() { return getPlacesMedia; });
...
var reducers = {
    ...
    country: __WEBPACK_IMPORTED_MODULE_5__country_reducers_country_reducer__["k" /* reducer */]
};
/**
...
var getFollowStatus = Object(__WEBPACK_IMPORTED_MODULE_0_reselect__["createSelector"])(getCountryState, __WEBPACK_IMPORTED_MODULE_5__country_reducers_country_reducer__["h" /* getFollowStatus */]);
...
var getTripMedia = Object(__WEBPACK_IMPORTED_MODULE_0_reselect__["createSelector"])(getCountryState, __WEBPACK_IMPORTED_MODULE_5__country_reducers_country_reducer__["j" /* getTripMedia */]);
var getPlacesMedia = Object(__WEBPACK_IMPORTED_MODULE_0_reselect__["createSelector"])(getCountryState, __WEBPACK_IMPORTED_MODULE_5__country_reducers_country_reducer__["i" /* getPlacesMedia */]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngrx_store__ = __webpack_require__("./node_modules/@ngrx/store/@ngrx/store.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reducers__ = __webpack_require__("./src/app/core/reducers/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs_add_operator_skipLast__ = __webpack_require__("./node_modules/rxjs/_esm5/add/operator/skipLast.js");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__actions_error_actions__ = __webpack_require__("./src/app/core/actions/error.actions.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ModalManager = /** @class */ (function () {
    function ModalManager(dialog, router, store) {
        ...
        this.store = store;
        this.skip = false;
        router.events.filter(function (event) { return event instanceof __WEBPACK_IMPORTED_MODULE_7__angular_router__["b" /* NavigationStart */]; }).subscribe(function (res) {
            _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_8__actions_error_actions__["d" /* RemoveErrorAction */]());
            return !_this.skip && _this.dialog.closeAll();
        });
        this.modalRef$ = store.select(__WEBPACK_IMPORTED_MODULE_4__reducers__["n" /* getOpenedModalRef */]);
    ...
    ModalManager.prototype.openModalFromLCH = function (component, data, skip) {
        ...
        this.skip = skip;
        setTimeout(function () {
            _this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_2__actions_core_actions__["d" /* OpenModalAction */]({ ref: _this.dialog.open(component, { data: data }) }));
        }, 1);
    };
    ModalManager.prototype.openModal = function (component, data) {
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_2__actions_core_actions__["d" /* OpenModalAction */]({ ref: this.dialog.open(component, { data: data }) }));
    };
    ModalManager = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_material__["g" /* MatDialog */], __WEBPACK_IMPORTED_MODULE_7__angular_router__["c" /* Router */], __WEBPACK_IMPORTED_MODULE_3__ngrx_store__["h" /* Store */]])
    ], ModalManager);
    return ModalManager;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_country_service__ = __webpack_require__("./src/app/country/services/country.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CountryAboutBoxComponent = /** @class */ (function () {
    function CountryAboutBoxComponent(countryService) {
        this.countryService = countryService;
...
/***/ "./src/app/country/components/follow-button/follow-button.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/country/components/follow-button/follow-button.component.scss":
/***/ (function(module, exports) {
...
/***/ "./src/app/country/components/follow-button/follow-button.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return FollowButtonComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__actions_country_actions__ = __webpack_require__("./src/app/country/actions/country.actions.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_reducers__ = __webpack_require__("./src/app/core/reducers/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngrx_store__ = __webpack_require__("./node_modules/@ngrx/store/@ngrx/store.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_auto_unsubscribe__ = __webpack_require__("./node_modules/ngx-auto-unsubscribe/dist/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
...
var FollowButtonComponent = /** @class */ (function () {
    function FollowButtonComponent(store) {
        ...
        this.store = store;
        this.subscriptions = [
            this.store.select(__WEBPACK_IMPORTED_MODULE_2__core_reducers__["e" /* getCountryId */]).subscribe(function (id) { return _this.id = id; }),
            this.store.select(__WEBPACK_IMPORTED_MODULE_2__core_reducers__["k" /* getFollowStatus */]).subscribe(function (status) { return _this.isFollowed = status; })
        ];
    }
    ...
    FollowButtonComponent.prototype.toggleFollow = function () {
        ...
        this.isFollowed ?
            this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_1__actions_country_actions__["i" /* UnfollowCountryAction */](this.id)) :
            this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_1__actions_country_actions__["c" /* FollowCountryAction */](this.id));
    };
    ...
    FollowButtonComponent = __decorate([
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            template: __webpack_require__("./src/app/country/components/follow-button/follow-button.component.html"),
            styles: [__webpack_require__("./src/app/country/components/follow-button/follow-button.component.scss")]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__ngrx_store__["h" /* Store */]])
...
var PlacesListComponent = /** @class */ (function () {
    function PlacesListComponent(store) {
        this.store = store;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_country_service__ = __webpack_require__("./src/app/country/services/country.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_reducers__ = __webpack_require__("./src/app/core/reducers/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ngrx_store__ = __webpack_require__("./node_modules/@ngrx/store/@ngrx/store.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__actions_country_actions__ = __webpack_require__("./src/app/country/actions/country.actions.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_places_list_places_list_component__ = __webpack_require__("./src/app/country/components/places-list/places-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_holidays_list_holidays_list_component__ = __webpack_require__("./src/app/country/components/holidays-list/holidays-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__core_services_convert_service__ = __webpack_require__("./src/app/core/services/convert.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CountryComponent = /** @class */ (function () {
    function CountryComponent(route, router, converService, countryService, store) {
        var _this = this;
        this.route = route;
        this.router = router;
        ...
        this.countryService = countryService;
        this.store = store;
        this.placesList = __WEBPACK_IMPORTED_MODULE_7__components_places_list_places_list_component__["a" /* PlacesListComponent */];
        this.holidaysList = __WEBPACK_IMPORTED_MODULE_8__components_holidays_list_holidays_list_component__["a" /* HolidaysListComponent */];
        /**
         * Check if this component is country or city
         */
        this.isCountry = this.countryService.getType() === 'countries';
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_5__actions_country_actions__["f" /* SetCountryInfoAction */](this.route.snapshot.data.country));
        /**
         * Get data for component (country or city)
         */
        this.store.select(__WEBPACK_IMPORTED_MODULE_3__core_reducers__["c" /* getCountry */]).subscribe(function (res) {
    ...
    CountryComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_6_ngx_auto_unsubscribe__["a" /* AutoUnsubscribe */])(),
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */],
            ...
            __WEBPACK_IMPORTED_MODULE_9__core_services_convert_service__["a" /* ConvertService */],
            __WEBPACK_IMPORTED_MODULE_2__services_country_service__["a" /* CountryService */],
            __WEBPACK_IMPORTED_MODULE_4__ngrx_store__["h" /* Store */]])
    ], CountryComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_follow_button_follow_button_component__ = __webpack_require__("./src/app/country/components/follow-button/follow-button.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__core_components_gallery_modal_gallery_modal_component__ = __webpack_require__("./src/app/core/components/gallery-modal/gallery-modal.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__components_country_about_box2_country_about_box2_component__ = __webpack_require__("./src/app/country/components/country-about-box2/country-about-box2.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__components_country_indexes_box_country_indexes_box_component__ = __webpack_require__("./src/app/country/components/country-indexes-box/country-indexes-box.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__angular_material_slider__ = __webpack_require__("./node_modules/@angular/material/esm5/slider.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_country_emergency_number_country_emergency_number_component__ = __webpack_require__("./src/app/country/components/country-emergency-number/country-emergency-number.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_places_list_places_list_component__ = __webpack_require__("./src/app/country/components/places-list/places-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_holidays_list_holidays_list_component__ = __webpack_require__("./src/app/country/components/holidays-list/holidays-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_country_budget_box_country_budget_box_component__ = __webpack_require__("./src/app/country/components/country-budget-box/country-budget-box.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__modals_country_accordion_modal_country_accordion_modal_component__ = __webpack_require__("./src/app/country/modals/country-accordion-modal/country-accordion-modal.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__core_pipes_keysPipe__ = __webpack_require__("./src/app/core/pipes/keysPipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__core_services_convert_service__ = __webpack_require__("./src/app/core/services/convert.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    CountryModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            ...
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_13__components_follow_button_follow_button_component__["a" /* FollowButtonComponent */],
                __WEBPACK_IMPORTED_MODULE_15__components_country_about_box2_country_about_box2_component__["a" /* CountryAboutBox2Component */],
                __WEBPACK_IMPORTED_MODULE_16__components_country_indexes_box_country_indexes_box_component__["a" /* CountryIndexesBoxComponent */],
                __WEBPACK_IMPORTED_MODULE_18__components_country_emergency_number_country_emergency_number_component__["a" /* CountryEmergencyNumberComponent */],
                __WEBPACK_IMPORTED_MODULE_19__components_places_list_places_list_component__["a" /* PlacesListComponent */],
                __WEBPACK_IMPORTED_MODULE_20__components_holidays_list_holidays_list_component__["a" /* HolidaysListComponent */],
                __WEBPACK_IMPORTED_MODULE_21__components_country_budget_box_country_budget_box_component__["a" /* CountryBudgetBoxComponent */],
                __WEBPACK_IMPORTED_MODULE_22__modals_country_accordion_modal_country_accordion_modal_component__["a" /* CountryAccordionModalComponent */],
                __WEBPACK_IMPORTED_MODULE_23__core_pipes_keysPipe__["a" /* KeysPipe */]
            ],
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_24__core_services_convert_service__["a" /* ConvertService */]
            ],
            entryComponents: [
                __WEBPACK_IMPORTED_MODULE_14__core_components_gallery_modal_gallery_modal_component__["a" /* GalleryModalComponent */],
                __WEBPACK_IMPORTED_MODULE_19__components_places_list_places_list_component__["a" /* PlacesListComponent */],
                __WEBPACK_IMPORTED_MODULE_20__components_holidays_list_holidays_list_component__["a" /* HolidaysListComponent */],
                __WEBPACK_IMPORTED_MODULE_22__modals_country_accordion_modal_country_accordion_modal_component__["a" /* CountryAccordionModalComponent */]
            ]
...
var CountryRoutes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: __WEBPACK_IMPORTED_MODULE_2__core_components_modal_wrapper_modal_wrapper_component__["a" /* ModalWrapperComponent */],
                data: { modal: __WEBPACK_IMPORTED_MODULE_3__core_components_gallery_modal_gallery_modal_component__["a" /* GalleryModalComponent */], getFunc: __WEBPACK_IMPORTED_MODULE_4__core_reducers__["r" /* getTripMedia */], skipClose: true }
            },
            {
                path: 'place-media/:mediaId',
                component: __WEBPACK_IMPORTED_MODULE_2__core_components_modal_wrapper_modal_wrapper_component__["a" /* ModalWrapperComponent */],
                data: { modal: __WEBPACK_IMPORTED_MODULE_3__core_components_gallery_modal_gallery_modal_component__["a" /* GalleryModalComponent */], getFunc: __WEBPACK_IMPORTED_MODULE_4__core_reducers__["o" /* getPlacesMedia */], skipClose: true }
            }
        ]
    }
];
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return getFollowStatus; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return getTripMedia; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return getPlacesMedia; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__country_service__ = __webpack_require__("./src/app/country/services/country.service.ts");
...
var CountryInfoResolver = /** @class */ (function () {
    ...
    CountryInfoResolver = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__country_service__["a" /* CountryService */],
            __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]])
    ], CountryInfoResolver);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__auth_guards_can_activate_guard__ = __webpack_require__("./src/app/auth/guards/can-activate.guard.ts");
...
var HomeRoutes = [
    {
        ...
        canActivate: [__WEBPACK_IMPORTED_MODULE_1__auth_guards_can_activate_guard__["a" /* AuthGuard */]],
    }
];
...
var AddCityToTripModalComponent = /** @class */ (function () {
    ...
    function AddCityToTripModalComponent(store, fb, tripPlannerService, routeParams, route) {
        ...
        this.error$ = store.select(__WEBPACK_IMPORTED_MODULE_2__core_reducers_index__["j" /* getErrorFromServer */]);
    }
    AddCityToTripModalComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.store.select(__WEBPACK_IMPORTED_MODULE_2__core_reducers_index__["s" /* getTripPlannerState */]).subscribe(function (res) {
...
var AddPlaceToTripModalComponent = /** @class */ (function () {
    ...
    function AddPlaceToTripModalComponent(store, fb, tripPlannerService, routeParams, route) {
        ...
        this.places = [];
        this.closeLink = this.route.routerState.snapshot.url.endsWith('info') ? this.route.routerState.snapshot.url : 'trip/new';
        this.error$ = this.store.select(__WEBPACK_IMPORTED_MODULE_5__core_reducers__["j" /* getErrorFromServer */]);
